...
?>
					...
					<tr valign="top"><th scope="row"><strong><?php _e('Unknown Font Size',"FLIR"); ?>: </strong></th><td valign="top">
					...
					<br /><?php _e('All generated images are cached. If you have a large site with many different bits of text being replaced, this may lead to a lot of old, outdated images in the cache.  This will allow you to specify how often to run the cache cleanup in relation to how often FLIR is executed.<br /><strong><em>Default: Never</em></strong>',"FLIR"); ?></td>
					</tr>
		  ...
		  closedir($handle);
					...
					?>
					  ...
					  <select name="font_default">
						...
						<br /><?php _e('If the font cannot be determined automatically or is not specified in the Elements to Replace section the rendered font will default to the one selected here.<br /><strong><em>Default: First font in font directory</em></strong>',"FLIR"); ?></td>
					</tr>
