...
#test-link { color:red !important; }
#test-link:hover { color:blue !important; }
...
a.update { float:right; display:block; background:url(http://facelift.mawhorter.net/i/btn-flir-update.png) no-repeat; width:150px; height:35px; text-align:center; padding:15px 0 0; color:white; }
a.update:hover { background:url(http://facelift.mawhorter.net/i/btn-flir-update.png) no-repeat bottom; }

#example.ex-bkg { background:url(http://facelift.mawhorter.net/i/flir-ex-bkg.jpg) no-repeat; }
.example-bkg { padding:10px 10px 0; color:#3011bd; }
.example-bkg.flir-replaced { padding:6px 10px 0; color:#3011bd; }

.hover { font-size:38px; font-family:Geo, arial; color:#4f4f4f; }
.hover a:hover { color:red; text-decoration:none; }
#hover-2 .dark-pink { color:#CC33CC; }
#hover-2 .light-pink { color:#CC99CC; }
#hover-2:hover .dark-pink { color:#3399CC; }
#hover-2:hover .light-pink { color:#3333CC; }
#hover-4 #link-1 { color:green; }
#hover-4 #link-1:hover { color:red; }
#hover-4 #link-2 { color:dodgerblue; }
#hover-4 #link-2:hover { color:darkblue; }
#hover-5 { font-size:58px; }
</style>
<!--[if IE]>
<style type="text/css">
