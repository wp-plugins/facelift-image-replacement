<?php
	      ...
	      $flirConfig_data .= "/* Facelift Image Replacement v1.2".$this->eol().$this->eol();
        ...
        $flirConfig_data .= "define('PLUGIN_DIR', '".$pluginDir."');".$this->eol().$this->eol();
	      ...
	      $flirConfig_data .= '//$fonts[\'courier new\'] = $fonts[\'courier\'] = $fonts[\'monospace\'] 	= $fonts[\'geo\'];'.$this->eol();
